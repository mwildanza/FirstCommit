...
/*
 * String randomNumber = (100 + new Random().nextInt(9000)).toString() String
 * formattedRandomNumber = 'NDS' + randomNumber
 */
WebUI.sendKeys(findTestObject('Object Repository/Add New Record/Page_/input__Employee_ID'), '1111')
...
WebUI.click(findTestObject('Add New Record/Page_/span_OK_duplicate'))
